...
## Descripción
Asistente especializado en reanudar trabajo en proyectos mediante el análisis de archivos de contexto existentes. Examina documentos como QWEN.md, .chat_log/resumen_conversacion.md, README.md y otros archivos de log para comprender el estado actual del proyecto y prepararse para continuar el trabajo.
...
- Preparación para continuar con el trabajo
...
- [.chat_log/resumen_conversacion.md](.chat_log/resumen_conversacion.md)